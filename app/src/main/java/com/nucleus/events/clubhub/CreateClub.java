...
//
        ...
        databaseReference1 = FirebaseDatabase.getInstance().getReference().child("students").child(cuid).child("myclubs").child(club_uid);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable final Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            Toast.makeText(this, "Crop image does'nt supported", Toast.LENGTH_SHORT).show();
            // loadingBar.dismiss();
        }
