...
import com.nucleus.events.clubhub.adapters.ClubsAdapter;
...
public class Clubs_fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final List<ClubsModel> list = new ArrayList<>();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot Snapshot) {
                ...
                for (DataSnapshot dataSnapshot : Snapshot.getChildren()) {
                    ...
                    ClubsModel clubsModel = dataSnapshot.getValue(ClubsModel.class);

                    Toast.makeText(getContext(), "loading clibs", Toast.LENGTH_SHORT).show();

                    list.add(clubsModel);
                }

                clubsAdapter = new ClubsAdapter(list,getContext());

                recyclerView.setAdapter(clubsAdapter);
                Toast.makeText(getContext(), "loaded clubs", Toast.LENGTH_SHORT).show();
