...
String ccollage,cname,clogo,ccatagory,crating,cmembers;

    public ClubsModel(String ccollage, String cname, String clogo, String ccatagory, String crating, String cmembers) {
